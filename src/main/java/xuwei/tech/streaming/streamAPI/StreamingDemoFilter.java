...
public class StreamingDemoFilter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Long> num = text.map(new MapFunction<Long, Long>() {
            private static final long serialVersionUID = 215391841539119185L;
        ...
        DataStream<Long> filterData = num.filter(new FilterFunction<Long>() {
            private static final long serialVersionUID = 899472565036958838L;
        ...
        DataStream<Long> resultData = filterData.map(new MapFunction<Long, Long>() {
            private static final long serialVersionUID = -3692675078259315900L;

...
public class StreamingWindowWatermark2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple2<String, Long>> inputMap = text.map(new MapFunction<String, Tuple2<String, Long>>() {
            private static final long serialVersionUID = -159460297785426281L;
        ...
        DataStream<Tuple2<String, Long>> waterMarkStream = inputMap.assignTimestampsAndWatermarks(new AssignerWithPeriodicWatermarks<Tuple2<String, Long>>() {
            ...
            private static final long serialVersionUID = 7028572878889513150L;
        ...
        OutputTag<Tuple2<String, Long>> outputTag = new OutputTag<Tuple2<String, Long>>("late-data") {
            private static final long serialVersionUID = 5995934124906808133L;
        };
        ...
        SingleOutputStreamOperator<String> window = waterMarkStream.keyBy(0)
                ...
                .apply(new WindowFunction<Tuple2<String, Long>, String, Tuple, TimeWindow>() {
                    private static final long serialVersionUID = 6514666239245570663L;

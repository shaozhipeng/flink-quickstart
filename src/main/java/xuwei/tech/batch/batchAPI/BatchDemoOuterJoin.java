    ...
    public static void main(String[] args) throws Exception {
        ...
        text1.leftOuterJoin(text2)
                ...
                .with(new JoinFunction<Tuple2<Integer, String>, Tuple2<Integer, String>, Tuple3<Integer, String, String>>() {
                    private static final long serialVersionUID = 3464574338608702933L;
        ...
        text1.rightOuterJoin(text2)
                ...
                .equalTo(0)
                .with(new JoinFunction<Tuple2<Integer, String>, Tuple2<Integer, String>, Tuple3<Integer, String, String>>() {
                    private static final long serialVersionUID = 2489442851337847294L;
        ...
        text1.fullOuterJoin(text2)
                ...
                .equalTo(0)
                .with(new JoinFunction<Tuple2<Integer, String>, Tuple2<Integer, String>, Tuple3<Integer, String, String>>() {
                    private static final long serialVersionUID = 1519440916703469937L;
